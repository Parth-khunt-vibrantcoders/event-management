...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" >
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('dashboard') }}" class="brand-logo">
            <img alt="Logo" src="{{  asset('public/upload/systemsetting/logo-temp.png') }}" class="max-h-55px" />
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ ( $currentRoute  ==  "places-list"   || $currentRoute  ==  "places-edit"   || $currentRoute  ==  "places-add" ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                    <a href="{{ route('places-list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item {{ ( $currentRoute  ==  "packages-list"   || $currentRoute  ==  "packages-edit"   || $currentRoute  ==  "packages-add" ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                    <a href="{{ route('packages-list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item {{ ( $currentRoute  ==  "users-list"   ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ $currentRoute == "cancel-booking-list"  ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('cancel-booking-list') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">Cancel booking List</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item {{ ( $currentRoute  ==  "contact-us-list"   ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                    <a href="{{ route('contact-us-list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
