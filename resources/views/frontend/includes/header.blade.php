<head>
    ...
    <link rel="stylesheet" href="{{  asset('public/frontend/css/fontawesome-5-all.min.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/font-awesome.min.css') }}">
    <!-- LEAFLET MAP -->
    <link rel="stylesheet" href="{{  asset('public/frontend/css/leaflet.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/leaflet-gesture-handling.min.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/leaflet.markercluster.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/leaflet.markercluster.default.css') }}">
    ...
    <!-- ARCHIVES CSS -->
    <link rel="stylesheet" href="{{  asset('public/frontend/css/search.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/animate.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/aos.css') }}">
    <link rel="stylesheet" href="{{  asset('public/frontend/css/aos2.css') }}">
