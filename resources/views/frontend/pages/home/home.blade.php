                        ...
                        <div class="project-single" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-1.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-single" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-2.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-single" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-3.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-single no-mb" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-4.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-single no-mb" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-5.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-single no-mb last" data-aos="zoom-in">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <img src="{{  asset('public/frontend/images/feature-properties/fp-6.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="single-property-1.html" class="homes-img">
                                        ...
                                        <img src="{{  asset('public/frontend/images/blog/b-11.jpg') }}" alt="home-1" class="img-responsive">
                                    </a>
                                </div>
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="single-property-1.html" class="homes-img">
                                        ...
                                        <img src="{{  asset('public/frontend/images/feature-properties/fp-10.jpg') }}" alt="home-1" class="img-responsive">
                                    </a>
                                </div>
                                <div class="button-effect">
                                    <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                    ...
                    <div class="row">
                            ...
                            <div class="news-item" data-aos="fade-up">
                                <a href="blog-details.html" class="news-img-link">
                                    <div class="news-item-img">
                                        <img class="img-responsive" src="{{  asset('public/frontend/images/blog/b-1.jpg') }}" alt="blog image">
                                    </div>
                                </a>
                                <div class="news-item-text">
                                    ...
                                    <div class="news-item-bottom">
                                        ...
                                        <div class="admin">
                                            <p>By, Karl Smith</p>
                                            <img src="{{  asset('public/frontend/images/testimonials/ts-6.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-xs-12">
                            <div class="news-item" data-aos="fade-up">
                                <a href="blog-details.html" class="news-img-link">
                                    <div class="news-item-img">
                                        <img class="img-responsive" src="{{  asset('public/frontend/images/blog/b-2.jpg') }}" alt="blog image">
                                    </div>
                                </a>
                                <div class="news-item-text">
                                    ...
                                    <div class="news-item-bottom">
                                        ...
                                        <div class="admin">
                                            <p>By, Lis Jhonson</p>
                                            <img src="{{  asset('public/frontend/images/testimonials/ts-5.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-xs-12">
                            <div class="news-item no-mb" data-aos="fade-up">
                                <a href="blog-details.html" class="news-img-link">
                                    <div class="news-item-img">
                                        <img class="img-responsive" src="{{  asset('public/frontend/images/blog/b-3.jpg') }}" alt="blog image">
                                    </div>
                                </a>
                                <div class="news-item-text">
                                    ...
                                    <div class="news-item-bottom">
                                        ...
                                        <div class="admin">
                                            <p>By, Ted Willians</p>
                                            <img src="{{  asset('public/frontend/images/testimonials/ts-4.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
